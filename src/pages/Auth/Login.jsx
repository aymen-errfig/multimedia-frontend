    ...
    return (
        <AuthLayout title={"Login"} description={"hello world a simple text"}>
            <form>
                <div className="py-2">
                    <Label>email</Label>
                    <Input placeholder="example@examnple.com" onChange={(e) => setEmail(e.target.value)} value={email}/>
                </div>
                <div className="py-2">
                    <Label>password</Label>
                    <Input placeholder="********" onChange={(e) => setPassword(e.target.value)} value={password}
                           type="password"/>
                </div>
                <div className="pb-2">
                    <a href="/" className="underline">forgot your password ?</a>
                </div>
                <Button onClick={handleLogin} type={"reset"} className="mt-2">
